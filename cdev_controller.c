...
// ioctl code references outdated buffer, isn't properly reviewed and may be working with a lot of test code.
// I've commented it out until issues are resolved - David
